                    ...
                    <tbody class="no-border-y">
                      ...
                      ?>
                        <tr>
                            ...
                            <td><img width="40px" src="<?php echo base_url('assets/images/market/'); ?><?php echo $market->img; ?>" alt=""></td>
                            <td><?php echo $market->created_at; ?></td>
                            <td><?php echo $market->updated_at; ?></td>
                            <td><?php echo $market->author; ?></td>
                            <td><?php echo $this->mfunction->status($market->status);?>
                            </td>
                            <td class="text-center">
                                <a class="label label-info" id="getMarket" data-id="<?php echo $market->market_id; ?>" data-toggle="modal" data-target="#form-bp1"><i class="fa fa-eye"></i></a>
                                <a class="label label-default" href="<?php echo $linkupdate; ?><?php echo $market->market_id; ?>"><i class="fa fa-pencil-alt"></i></a>
                                <a class="label label-danger" href="<?php echo $linkdelete; ?><?php echo $market->market_id; ?>" onClick="javascript: return confirm('Are you sure delete this data?');"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                      <?php } ?>
                    </tbody>

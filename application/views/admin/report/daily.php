        ...
        <div class="content">
                ...
                ?>
                    ...
                    <tbody class="no-border-y">
                      <?php $no=1;
                            foreach ($data as $productd) {
                      ?>
                        <tr>
                            <td><?php echo $no++ ?></td>
                            <td><?php echo $productd->name; ?></td>
                            <td><?php echo $productd->unit; ?></td>
                            <td><img src="<?php echo base_url('assets/images/product/') ?><?php echo $productd->img; ?>" width="40px"></td>
                            <td><?php echo $productd->price; ?></td>
                            <td><?php echo $productd->date; ?></td>
                            <td><?php echo $productd->market; ?></td>
                            <td><?php echo $productd->author; ?></td>
                            <td><?php echo $this->mfunction->status($productd->status) ?>
                            </td>
                            <td class="text-center">
                                <a class="label label-info md-trigger" id="getProductd" data-id="<?php echo $productd->pd_id; ?>" data-toggle="modal" data-target="#form-bp1"><i class="fa fa-eye"></i></a>
                                <a class="label label-default" href="<?php echo $linkupdate; ?><?php echo $productd->pd_id; ?>"><i class="fa fa-pencil-alt"></i></a>
                                <a class="label label-danger" href="<?php echo $linkdelete; ?><?php echo $productd->pd_id; ?>" onClick="javascript: return confirm('Are you sure delete this data?');"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                      <?php } ?>
                    </tbody>

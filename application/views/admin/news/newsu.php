      ...
      <div class="pull-right">
        ...
        <div class="content">
          <?php echo validation_errors(); echo $this->session->flashdata('failedupdate');?>
            <form class="form-horizontal group-border-dashed" style="border-radius: 0px;" enctype="multipart/form-data" role="form" method="POST" action="<?php echo base_url('admin/News/updateProccess');  ?>">
                <div class="form-group">
                    <label class="col-sm-3 control-label">Title</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="title" value="<?php echo $data->title; ?>" placeholder="Ex. John" required>
                        <input type="hidden" class="form-control" name="nid" value="<?php echo $data->news_id; ?>" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <img src="<?php echo base_url('assets/images/news/'); ?><?php echo $data->img; ?>" width="100px;">
